    ...
    def get_loc(timelog)
        ...
        begin
            ...
            commits.each do |commit|
                if commit.date.to_date <= (current_date + 7)
                    if newest_commit.nil? or newest_commit.date.to_date < commit.date.to_date
        ...
        if last_commit.nil? and newest_commit.nil?
            return 0
        end
        git.diff(newest_commit, last_commit).insertions.to_i
    end
